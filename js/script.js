...
scrollAnimation.reveal(".hero__subtitle", { delay: 100 });
scrollAnimation.reveal(".get_started_btn", { delay: 200 });
scrollAnimation.reveal(".stats", { interval: 400 });

/* === FEATURED === */
scrollAnimation.reveal(".featured p", { delay: 100 });
scrollAnimation.reveal(".featured_list_item", { interval: 400 });

/* === FEATURES === */
scrollAnimation.reveal(".section_name", { delay: 100 });
scrollAnimation.reveal(".section_title", { delay: 100 });
scrollAnimation.reveal(".features_card", { interval: 700 });

/* === BLOG === */
scrollAnimation.reveal(".grid", { delay: 100 });
scrollAnimation.reveal(".blog_card", { interval: 700 });
